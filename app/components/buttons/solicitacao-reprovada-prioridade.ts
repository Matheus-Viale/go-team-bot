...
module.exports = {
    ...
    async execute(interaction: ButtonInteraction, client: Client){
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`${streamerNick}, o seu agendamento para ${dia} às ${horario}(BR) foi reprovado!\nMas você está fazendo tudo certo, continue assim, o horário já havia sido solicitado por outro streamer que pediu mais cedo e/ou realizou menos lives na semana!`)
        ;
