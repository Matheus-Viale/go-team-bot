...
module.exports = {
    ...
    async execute(interaction, client){
        ...
        streamerUser.send({
            content: `Olá ${streamerNick}, o seu agendamento para ${dia} às ${horario}(BR) foi reprovado por você possuir uma advertência! Para mais informações entrar em contato com a STAFF!`
        }).catch(error =>{
            channelNotificacoesFetch.send({
                content: `Olá <@${streamerId}>, o seu agendamento para ${dia} às ${horario}(BR) foi reprovado por você possuir uma advertência! Para mais informações entrar em contato com a STAFF!`
            })
        })
