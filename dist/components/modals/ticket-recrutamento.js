    ...
    execute(interaction, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield guild.channels.create({
                    ...
                    const embedTicket2 = new discord_js_1.EmbedBuilder()
                        ...
                        .addFields({ name: '\u200B', value: '\u200B' }, { name: 'Configuração de Privacidade', value: 'Eu, o bot da Go Team converso diretamente com vocês streamers, então por gentileza, nas opções na seta ao lado do nome do server na parte superior do discord, vá em Config de Privacidade e habilite "Mensagens Diretas", para que eu consiga te notificar sobre suas solicitações e seus agendamentos. (Não se preocupe, eu não faço nenhum tipo de SPAM)' }, { name: '\u200B', value: '\u200B' }, { name: 'Como Funciona:', value: `Nosso grupo funciona com agendamento e acompanhamento de lives. Todo dia tem uma agenda com streamers diferentes e você tem que acompanhar ou deixar em "lurk" as lives para poder agendar a sua.\n\nOs horários da nossa agenda são de 2 horas.` }, { name: '\u200B', value: '\u200B' }, { name: 'Nossos horários:', value: 'As lives acontecem todos os dias das **10:00** às **00:00**, conforme os horários abaixo:\n\n10:00 às 12:00\n12:00 às 14:00\n14:00 às 16:00\n16:00 às 18:00\n18:00 às 20:00\n20:00 às 22:00\n22:00 às 00:00' }, { name: '\u200B', value: '\u200B' }, { name: 'Como agendar:', value: 'A agenda abre todos os dias às **12:00** e fecha às **21:00**, com os agendamentos sempre para o dia seguinte.' }, { name: '\u200B', value: '\u200B' }, { name: 'Requisitos para agendar:', value: 'A única coisa que exigimos obrigatoriamente é acompanhar ou deixar em "lurk" as lives, temos uma lista de presença que usamos para saber quem está colaborando!' }, { name: '\u200B', value: '\u200B' }, { name: 'Você concorda?', value: 'Caso esteja de acordo em participar e colaborar com o grupo, acompanhando as lives dos colegas basta responder com OK e iremos lhe guiar sobre como acompanhar as lives e agendar, além de verificar sua presença e justificar caso precise se ausentar.' }, { name: '\u200B', value: '\u200B' }, { name: 'Dúvidas?', value: 'Caso queira tirar qualquer dúvida antes de aceitar, basta perguntar aqui no chat e algum recrutador irá lhe responder assim que possível!' });
            ...
            const embedRecrutados1 = new discord_js_1.EmbedBuilder()
                ...
                .addFields({ name: 'Canal da Twitch:', value: `${nomeTwitch}` }, { name: 'Afiliado:', value: `${afiliadoTwitch}` }, { name: 'Tempo de Streamer:', value: `${tempoLive}` }, { name: 'Recomendação:', value: `${recomendacao}` });
