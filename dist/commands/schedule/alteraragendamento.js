        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield agendamentoCriado.save().then((novoAgendamento) => __awaiter(this, void 0, void 0, function* () {
                ...
                channelAgendamentoStaffFetch.send({
                    content: `Agendamento da data ${novoAgendamento.diaAgendamento} foi atualizado por ${member.displayName} com o streamer ${streamerTwitch} agendado para o horário das ${horario}:00`
                });
                yield interaction.editReply({
